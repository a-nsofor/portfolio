...
t.tinyMCE=t.top.tinyMCE;t.tinyMCEPreInit=t.top.tinyMCEPreInit;t.tinymce=t.top.tinymce;t.switchEditors=t.top.switchEditors;t.wpApiSettings=t.top.wpApiSettings;ThemifyConstructor.getForms(d.render)},null,null,function(){return"undefined"!==typeof ThemifyConstructor});r.addEventListener("submit",function(a){a.preventDefault()});r.addEventListener("click",function(a){var b=a.target;(b="A"===b.tagName?b:b.closest("a"))&&"#"!==b.href&&""!==b.href&&b.href.replace((new URL(b.href)).hash,"")!==t.top.location.href.replace(location.hash,
"")&&a.preventDefault()})});const q=function(){this.$context=u("#tb_lightbox_parent",w.document);this.$liveStyledElmt=null;this.module_rules={};this.rulesCache={};this.currentStyleObj={}};q.prototype.init=function(a,b){let c;var e=d.activeModel.get("element_id");this.type=d.activeModel.get("elType");this.group="module"===this.type?d.activeModel.get("mod_name"):this.type;!0===b&&null!==d.GS.previousModel?(e=d.Models.Registry.lookup(d.GS.previousModel),c=e.get("elType"),"module"===c&&(c=e.get("mod_name")),
e=e.get("element_id")):c=this.group;this.prefix=ThemifyStyles.getBaseSelector(c,e);this.$liveStyledElmt=b?u(r.querySelector(this.prefix)):d.Instances.Builder[d.builderIndex].$el.find(".tb_element_cid_"+d.activeModel.cid).first();this.currentStyleObj={};this.tempData={};this.undoData={};this.undoData[d.activeBreakPoint]={};this.tempData[d.activeBreakPoint]={};void 0===this.rulesCache[d.activeBreakPoint]&&(this.rulesCache[d.activeBreakPoint]={});this.currentSheet=this.getSheet(d.activeBreakPoint,b);
!0!==a&&("column"!==this.type&&"subrow"!==this.type&&this.bindAnimation(),this.bindTabsSwitch(),this.initModChange())};q.prototype.setCss=function(a,b,c){a=d.GS.createCss(a,b,void 0);b=[];for(let d in a)if("fonts"===d||"cf_fonts"===d)for(let c in a[d]){var e=c;0<a[d][c].length&&(e+=":"+a[d][c].join(","));b.push(e)}else if("gs"===d){e=a[d];for(let a in e){var g=this.getSheet(a,!0);let b=g.cssRules?g.cssRules:g.rules;for(let c in e[a])!1===K(b,c)&&g.insertRule(c+"{"+e[a][c].join("")+";}",b.length)}}else if("bg"!==
d){e=this.getSheet(d,c);g=e.cssRules?e.cssRules:e.rules;for(let b in a[d])!1===K(g,b)&&e.insertRule(b+"{"+a[d][b].join("")+";}",g.length)}ThemifyConstructor.font_select.loadGoogleFonts(b.join("|"));return a};q.prototype.setLiveStyle=function(a,b,c){c?"string"===typeof c&&(c=[c]):c=[""];c=ThemifyStyles.getNestedSelector(c);let e="";const g=this.currentSheet.cssRules?this.currentSheet.cssRules:this.currentSheet.rules;for(let a=0,b=c.length;a<b;++a){var f="h"===this.styleTabId?c[a].endsWith(":after")||
c[a].endsWith(":before"):!0;!1===f&&-1===c[a].indexOf(":hover")&&(c[a]+=":hover");e+=this.prefix+c[a];!1===f&&(e+=","+this.prefix+c[a].replace(":hover",".tb_visual_hover"));a!==b-1&&(e+=",")}if(!0===this.isChanged)if("h"===this.styleTabId){f=e.split(",");for(var k=f.length-1;-1<k;--k)if(-1===f[k].indexOf("tb_visual_hover")){c=r.querySelectorAll(f[k].split(":hover")[0]);for(var l=c.length-1;-1<l;--l)c[l].classList.add("tb_visual_hover")}}else for(this.$liveStyledElmt[0].classList.remove("tb_visual_hover"),
